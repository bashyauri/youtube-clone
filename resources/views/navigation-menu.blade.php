...
@auth
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                <x-mary-button label="Upload Video" @click="$wire.dispatch('toggleModal')"  class="btn-primary"/>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        ...
                        <div class="ms-3 relative">
                            <x-mary-dropdown>
                                ...
                                <x-mary-menu-item icon="fas.cog" title="Account Settings"
